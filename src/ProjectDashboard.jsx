          ...
          <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-100 space-y-4 animate-in fade-in slide-in-from-bottom-4 duration-300">
            <div className="flex flex-col md:flex-row gap-4 justify-between">
              ...
              <div className="flex flex-col sm:flex-row gap-4 flex-1">
                <input type="text" placeholder="Cari job atau proyek..." onChange={(e) => setSearchTerm(e.target.value)} className="flex-1 border border-slate-300 focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 outline-none rounded-xl p-2.5 transition-all max-w-sm" />
                <select onChange={(e) => setFilterYear(e.target.value)} className="border border-slate-300 outline-none focus:border-indigo-500 rounded-xl p-2.5 cursor-pointer">
                  <option value="All">Semua Tahun</option>
                  <option value="2026">2026</option>
                  <option value="2025">2025</option>
                </select>
                <select onChange={(e) => setFilterStatus(e.target.value)} className="border border-slate-300 outline-none focus:border-indigo-500 rounded-xl p-2.5 cursor-pointer">
              ...
              <div className="flex items-center gap-3 shrink-0">
                <button 
                  ...
                  className="bg-white border border-slate-300 text-slate-700 hover:border-indigo-500 hover:text-indigo-600 px-4 py-2.5 rounded-xl font-medium transition-colors flex items-center justify-center gap-2"
                >
